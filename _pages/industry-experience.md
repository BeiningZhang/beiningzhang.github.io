    ...
    <div class="example-block">
      ...
      <div class="example-good">
        <ul>
          ...
          <li>Productionised transaction-monitoring, thesis-led buyer-ranking, and AI deal-preparation workflows with versioned attempts, durable checkpoints, canonical company identity, auditable human feedback, retry-safe launches, degraded modes, and cross-service failure alerts — improving recovery, operational reliability, and adviser trust.</li>
        </ul>
      </div>
    </div>
  </article>
