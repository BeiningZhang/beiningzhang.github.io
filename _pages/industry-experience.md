    ...
    <div class="example-block">
      ...
      <div class="example-good">
        <ul>
          ...
          <li>Productionised transaction-monitoring, buyer-ranking, and AI deal-preparation workflows; introduced buyer-type-specific discovery stages, canonical identity, evidence provenance, quality evaluation, bounded orchestration, retry-safe launches, and cross-service failure alerts — improving reproducibility, recovery, and adviser trust.</li>
        </ul>
      </div>
    </div>
  </article>
