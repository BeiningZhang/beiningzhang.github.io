    ...
    <div class="example-block">
      ...
      <div class="example-good">
        <ul>
          ...
          <li>Improved an early transaction-monitoring pipeline’s production reliability by canonicalising transaction identities, retaining multi-source evidence, scoping canary runs, isolating buyer failures, and introducing bounded concurrency — creating an auditable banker-review path before wider automation.</li>
        </ul>
      </div>
    </div>
  </article>
